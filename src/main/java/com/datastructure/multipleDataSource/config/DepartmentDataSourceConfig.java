package com.datastructure.multipleDataSource.config;
...
@EnableJpaRepositories(
        basePackages = "com.datastructure.multipleDataSource.repository.department",
...
public class DepartmentDataSourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean departmentEntityManagerFactory(
        ...
        factoryBean.setPackagesToScan("com.datastructure.multipleDataSource.model.department");
