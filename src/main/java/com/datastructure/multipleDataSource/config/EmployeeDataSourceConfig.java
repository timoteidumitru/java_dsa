...
@EnableJpaRepositories(
        basePackages = "com.datastructure.multipleDataSource.repository.employee",
...
public class EmployeeDataSourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean employeeEntityManagerFactory(
        ...
        factoryBean.setPackagesToScan("com.datastructure.multipleDataSource.model.employee");
